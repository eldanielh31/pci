...
class pci_camera_component(StandardComponent):
    """Component that instantiates all the devices for the pci camera card"""
    _class_desc = "PCI camera component"
    ...
    def add_objects(self):
        sd = self.add_pre_obj('dev', 'pci_camera')
